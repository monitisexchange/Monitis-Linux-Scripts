...
declare -r APIKEY="34IEQU3T4CSOTNF06RADPFU702"			# ApiKey - REPLACE it by your key's value (can be obtained from your Monitis account)
declare -r SECRETKEY="7JF36T6EUL013FDBEQGHD6SVJQ"		# SecretKey - REPLACE it by your key's value (can be obtained from your Monitis account)
