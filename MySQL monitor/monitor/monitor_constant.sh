...
declare -r USER="root"					# remote MySQL master root user name
declare -r PASSWORD="r00t"			# remote MySQL master root user password
...
declare -r P1="queries:Queries::2;slow_queries:Slow_queries::2;thread_running:Threads_running::2;Connections_usage:Connections_usage:pr:4"
